...
<body>
	...
	<hr>
	<form name='frm' method='POST' action='./quiz/level4/quiz_4_4'
		...
		<div class='content_bottom_menu'>
			...
			<button id="btn_next" type="button" onclick="location.href='/quiz/level4/quiz_4_5'"
